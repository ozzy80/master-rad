...
\apstr{
Popularnost deljenja video sadržaja putem Interneta beleži značajan rast. Sadržaj generisan na ovakav način je obiman. Tako obiman sadržaj emiter može efikasnije distribuirati upotrebom mreže ravnopravnih računara. Upravo zbog kvaliteta mreže ravnopravnih računara pri razmeni video sadržaja implementiran je veliki broj protokola. Kako je veliki broj protokola baziran na brzoj distribuciji sadržaja i malom dodatnom sadržaju, ne postoji ni jedan opšte prihvaćeni protokol za dostavu sinhronizovanog sadržaja. U ovom radu predstavljen je potpuno novi protokol Kikkar. Protokol koristi hibridnu topologiju i omogućava dostavu sinhronizovanog sadržaja upotrebom mreže ravnopravnih računara. Eksperimentalni rezultati pokazali su da je dodatni sabraćaj koji protokol unosi kao i brzina propagacije sadržaja kroz mrežu slična sa drugim protokolima koji ne podržavaju sinhronizaciju.
}
...
U sekciji \ref{P2P.1} opisani su osnovni koncepti mreže ravnopravnih članova. U sekciji \ref{P2P.2} opisane su struktuirane i nestruktuirane mreže ravnopravnih članova. U sekciji \ref{P2P.3} opisane su topologija stabla (eng. \textit{tree topology}), mrežna (eng. \textit{mesh topology}) i hibridna (eng. \textit{hybrid topology}) topologija. Način pripreme i slanja video sadržaja opisan je u sekciji \ref{P2P.4}. U sekciji \ref{P2P.5} opisani su osnovni problemi prilikom pravljenja mreže ravnopravnih članova.
