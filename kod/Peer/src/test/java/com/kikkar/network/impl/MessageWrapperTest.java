...
class MessageWrapperTest {
	...
	void wrapMessageTest_checkControlMessageWrapper() {
		...
		PacketWrapper wrapExpected = PacketWrapper.newBuilder().setControlMessage(message).setPacketId(messageId).build();
	...
	void wrapMessageTest_checkKeepAliveMessageWrapper() {
		...
		PacketWrapper wrapExpected = PacketWrapper.newBuilder().setKeepAliveMessage(message).setPacketId(messageId).build();
		PacketWrapper wrapActual = MessageWrapper.wrapMessage(message, peerInformation);
	...
	void wrapMessageTest_checkNotInterestedMessageWrapper() {
		...
		PacketWrapper wrapExpected = PacketWrapper.newBuilder().setNotInterestedMessage(message).setPacketId(messageId).build();
		PacketWrapper wrapActual = MessageWrapper.wrapMessage(message, peerInformation);
	...
	void wrapMessageTest_checkRequestMessageWrapper() {
		...
		PacketWrapper wrapExpected = PacketWrapper.newBuilder().setRequestMessage(message).setPacketId(messageId).build();
		PacketWrapper wrapActual = MessageWrapper.wrapMessage(message, peerInformation);
	...
	void wrapMessageTest_checkRequestVideoMessageWrapper() {
		...
		PacketWrapper wrapExpected = PacketWrapper.newBuilder().setRequestVideoMessage(message).setPacketId(messageId).build();
		PacketWrapper wrapActual = MessageWrapper.wrapMessage(message, peerInformation);
	...
	void wrapMessageTest_checkResponseMessageWrapper() {
		...
		PacketWrapper wrapExpected = PacketWrapper.newBuilder().setResponseMessage(message).setPacketId(messageId).build();
		PacketWrapper wrapActual = MessageWrapper.wrapMessage(message, peerInformation);
	...
	void wrapMessageTest_checkResponseVideoMessageWrapper() {
		...
		PacketWrapper wrapExpected = PacketWrapper.newBuilder().setResponseVideoMessage(message).setPacketId(messageId).build();
		PacketWrapper wrapActual = MessageWrapper.wrapMessage(message, peerInformation);
	...
	void wrapMessageTest_checkTerminatedMessageWrapper() {
		...
		PacketWrapper wrapExpected = PacketWrapper.newBuilder().setTerminatedMessage(message).setPacketId(messageId).build();
		PacketWrapper wrapActual = MessageWrapper.wrapMessage(message, peerInformation);
